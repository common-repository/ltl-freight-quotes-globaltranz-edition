...
if (typeof enWdValidateInput != 'function') {
    function enWdValidateInput(form_id) {
        ...
        jQuery(form_id + " input[type='text']").each(function () {
            ...
            var errorElement = jQuery(this).parent().find('.engtz_wd_err');
 ...
 * @returns {Boolean}
 */
if (typeof engtz_wd_save_warehouse != 'function') {
    function engtz_wd_save_warehouse() {
        ...
        switch (true) {
            ...
            case (enable_local_delivery && jQuery("#add_warehouses #local-delivery-fee").val().length <= 0):
                jQuery("#add_warehouses #local-delivery-fee").parent().find(".engtz_wd_err").html("Local delivery fee is required.");
                return false;
        }


        var city = jQuery('#engtz_wd_origin_city').val();
        var tab = get_parameter_by_name('tab');

        var postForm = {
            'action': 'engtz_wd_save_warehouse',
            'origin_id': jQuery('#edit_form_id').val(),
            'origin_city': city,
            'origin_state': jQuery('#engtz_wd_origin_state').val(),
            // Origin terminal address
            'origin_address': jQuery('#en_wd_origin_address').val(),
            'origin_zip': jQuery('#engtz_wd_origin_zip').val(),
            'origin_country': jQuery('#engtz_wd_origin_country').val(),
            'origin_markup': jQuery('#en_wd_origin_markup').val(),
            'location': jQuery('#engtz_wd_location').val(),
            'tab': tab,
        };
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="engtz_wd_warehouse_list_heading_data">' + data.origin_city + '</td><td class="engtz_wd_warehouse_list_heading_data">' + data.origin_state + '</td><td class="engtz_wd_warehouse_list_heading_data">' + data.origin_zip + '</td><td class="engtz_wd_warehouse_list_heading_data">' + data.origin_country + '</td><td class="engtz_wd_warehouse_list_heading_data"><a href="javascript(0)" title="Edit" onclick="return engtz_wd_edit_warehouse(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-globaltranz-edition/includes/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return engtz_wd_delete_current_warehouse(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-globaltranz-edition/includes/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
 ...
 * @returns {Boolean}
 */
if (typeof engtz_wd_delete_current_warehouse != 'function') {
    function engtz_wd_delete_current_warehouse(e) {
        var tab = get_parameter_by_name('tab');
        var postForm = {
 ...
 * @returns {Boolean}
 */
if (typeof engtz_wd_edit_warehouse != 'function') {
    function engtz_wd_edit_warehouse(e) {
        var postForm = {
            'action': 'engtz_wd_edit_warehouse',
            'edit_id': e,
        };
        jQuery.ajax({
            type: 'POST',
            ...
            success: function (data) {
                if (data[0]) {
                    ...
                    jQuery('#engtz_wd_origin_zip').val(data[0].zip);
                    jQuery('.city_select').hide();
                    jQuery('#engtz_wd_origin_city').val(data[0].city);
                    jQuery('.city_input').show();
                    jQuery('#engtz_wd_origin_city').css('background', 'none');
                    jQuery('#engtz_wd_origin_state').val(data[0].state);
                    // Origin terminal address
                    jQuery('#en_wd_origin_address').val(data[0].address);
                    jQuery('#engtz_wd_origin_country').val(data[0].country);
                    ...
                    window.location.href = jQuery('.engtz_wd_add_warehouse_btn').attr('href');
 ...
 * @returns {Boolean}
 */
if (typeof engtz_wd_save_dropship != 'function') {
    function engtz_wd_save_dropship() {
        ...
        switch (true) {
            ...
            case (enable_local_delivery && jQuery("#add_dropships #local-delivery-fee").val().length <= 0):
                jQuery("#add_dropships #local-delivery-fee").parent().find(".engtz_wd_err").html("Local delivery fee is required.");
                return false;
        }

        var city = jQuery('#engtz_wd_dropship_city').val();
        var tab = get_parameter_by_name('tab');

        var postForm = {
            'action': 'engtz_wd_save_dropship',
            'dropship_id': jQuery('#edit_dropship_form_id').val(),
            'dropship_city': city,
            'nickname': jQuery('#engtz_wd_dropship_nickname').val(),
            'dropship_state': jQuery('#engtz_wd_dropship_state').val(),
            // Origin terminal address
            'dropship_address': jQuery('#en_wd_dropship_address').val(),
            'dropship_zip': jQuery('#engtz_wd_dropship_zip').val(),
            'dropship_country': jQuery('#engtz_wd_dropship_country').val(),
            'origin_markup': jQuery('#en_ds_origin_markup').val(),
            'location': jQuery('#engtz_wd_dropship_location').val(),
            'tab': tab,
        };
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="engtz_wd_dropship_list_data">' + data.nickname + '</td><td class="engtz_wd_dropship_list_data">' + data.origin_city + '</td><td class="engtz_wd_dropship_list_data">' + data.origin_state + '</td><td class="engtz_wd_dropship_list_data">' + data.origin_zip + '</td><td class="engtz_wd_dropship_list_data">' + data.origin_country + '</td><td class="engtz_wd_dropship_list_data"><a href="javascript(0)" title="Edit" onclick="return engtz_wd_edit_dropship(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-globaltranz-edition/includes/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return engtz_wd_delete_current_dropship(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-globaltranz-edition/includes/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
 ...
 * @returns {Boolean}
 */
if (typeof engtz_wd_edit_dropship != 'function') {
    function engtz_wd_edit_dropship(e) {
        var postForm = {
            'action': 'engtz_wd_edit_dropship',
            'dropship_edit_id': e,
        };
        jQuery.ajax({
            type: 'POST',
            ...
            success: function (data) {
                if (data[0]) {
                    ...
                    jQuery('#engtz_wd_dropship_zip').val(data[0].zip);
                    jQuery('.city_select').hide();
                    jQuery('#engtz_wd_dropship_nickname').val(data[0].nickname);
                    jQuery('#engtz_wd_dropship_city').val(data[0].city);
                    jQuery('.city_input').show();
                    jQuery('#engtz_wd_dropship_city').css('background', 'none');
                    jQuery('#engtz_wd_dropship_state').val(data[0].state);
                    // Origin terminal address
                    jQuery('#en_wd_dropship_address').val(data[0].address);
                    jQuery('#engtz_wd_dropship_country').val(data[0].country);
                    jQuery('#en_ds_origin_markup').val(data[0].origin_markup),
                    jQuery('.engtz_wd_zip_validation_err').hide();
                    jQuery('.engtz_wd_city_validation_err').hide();
                    jQuery('.engtz_wd_state_validation_err').hide();
                    jQuery('.engtz_wd_country_validation_err').hide();
 ...
 * @returns {Boolean}
 */
if (typeof engtz_wd_delete_current_dropship != 'function') {
    function engtz_wd_delete_current_dropship(e) {
        var id = e;
