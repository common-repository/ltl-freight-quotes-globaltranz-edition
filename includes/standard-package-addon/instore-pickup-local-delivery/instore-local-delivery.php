...
if (!class_exists("Engtz_Wd_Quotes")) {

    class Engtz_Wd_Quotes
    {

        public function __construct()
        {
            add_filter('engtz_wd_update_query_string', array($this, 'engtz_wd_update_query_string'), 10, 1);
            add_filter('engtz_wd_origin_array_set', array($this, 'engtz_wd_origin_array_set'), 10, 1);
            add_filter('engtz_wd_standard_plans', array($this, 'engtz_wd_standard_plans'), 10, 4);
        ...
        public function engtz_wd_standard_plans($post_data, $destination_zip, $origin_array, $package_plugin)
        {
            $action = $this->check_package_plan($package_plugin);
         ...
         * @return string
         */
        public function engtz_wd_update_query_string()
        {
         ...
         * @return array type
         */
        public function engtz_wd_origin_array_set($origin)
        {
