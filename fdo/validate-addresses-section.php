...
$va_obj = new \Engtz_Global_Tranz_Va();
            ...
            ?>
                <div id="message" class="en-coupon-code-div woocommerce-message en-coupon-notice">
                    ...
                    <p>
                        ...
                        <a href="javascript:void(0)" onclick="en_gtz_ltl_va_connection_status_refresh(this);">this link</a>
        ...
        <?php
            ...
            <div id="message" class="en-coupon-code-div woocommerce-message en-coupon-notice">
                ...
                <div class='en-coupon-btn-div'>
                    <button class="en_va_gtz_ltl_apply_promo_btn button" data-coupon="<?php echo $va_coupon_data['coupon'] ?>"><?php _e( 'Apply Promo Code', 'woocommerce' ); ?></button>
                </div>
            </div>
        <?php
        }
