...
class Engtz_Global_Tranz_Va
{
    ...
    public function get_va_coupon_data_from_api(){
        ...
        $url = GT_VA_COUPON_BASE_URL . "/use_coupon?".$data_encoded;
    ...
    public function get_va_coupon_parsed_data($va_coupon_data)
    {
        ...
        $parsed_data['register_url'] = GT_VA_COUPON_BASE_URL.'/register?code='.$base64string;
        $parsed_data['login_url'] = GT_VA_COUPON_BASE_URL.'/login?code='.$base64string;
        // $parsed_data['user_guide_get_started'] = GT_VA_COUPON_BASE_URL.'/help/Getting_Started';
