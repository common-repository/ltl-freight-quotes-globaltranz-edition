 ...
 * Class EnGlobaltranzFreightProductDetail
 * @package EnGlobaltranzFreightProductDetail
 */
if (!class_exists('EnGlobaltranzFreightProductDetail')) {
    ...
    class EnGlobaltranzFreightProductDetail
    {
        ...
        /**
         * Hook for call.
         * EnGlobaltranzFreightProductDetail constructor.
         */
        public function __construct()
        {
            add_filter('en_app_common_plan_status', [$this, 'en_globaltranz_freight_plan_status'], 10, 1);
         ...
         * @return array
         */
        public function en_globaltranz_freight_plan_status($plan_status)
        {
            $en_plugin_name = 'LTL Freight Quotes – GlobalTranz Edition';
            ...
            $plan_status['hazardous_material']['globaltranz_freight'][] = 'globaltranz_freight';
            ...
            $nesting_material = apply_filters("globaltranz_quotes_plans_suscription_and_features", 'nested_material');
            if (is_array($nesting_material)) {
                $plan_required = '1';
                $nested_material_status = $en_plugin_name . ': Upgrade to Advanced Plan to enable.';
            }

            $plan_status['nesting']['globaltranz_freight'][] = 'globaltranz_freight';
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['hazardous_material'])) {
                if (!in_array(0, $plan_status['hazardous_material']['plan_required'])) {
                    ...
                    $this->hazardous_plan_required = apply_filters("globaltranz_plans_notification_link", [2, 3]);
    ...
    new EnGlobaltranzFreightProductDetail();
}